...
{
    program.addShaderFromSourceFile(QOpenGLShader::Vertex, ":/standarshader.vs.glsl");
    program.addShaderFromSourceFile(QOpenGLShader::Fragment, ":/standarshader.fs.glsl");
    program.link();
